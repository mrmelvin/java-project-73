...
public class StatusControllerIT {
	...
	public void updateTask() throws Exception {
		...
		final var updateRequest = put("/api" + STATUS_CONTROLLER_PATH + StatusController.ID, statusId)
	...
	public void deleteTask() throws Exception {
		utils.createDefaultStatus();
		final Long statusId = statusRepository.findAll().iterator().next().getId();
		utils.perform(delete("/api" + STATUS_CONTROLLER_PATH + StatusController.ID, statusId), TEST_EMAIL)
				.andExpect(status().isOk());
